...
13							<a href="index.php" target="_blank"><i class="glyphicon glyphicon-calendar"></i> Take Attendance</a>
14					</li>
15					<li <?php if ($_GET['page'] == 'studentinfo') echo 'class="active"'; ?>>
16							<a href="index.php?page=studentinfo" target="_blank"><i class="glyphicon glyphicon-user"></i> Students List</a>
17					</li>
...
22							<a href="index.php?page=logout" target="_blank"><i class="glyphicon glyphicon-off"></i> Logout</a>
23					</li>
24			</ul>
	</nav>
<?php else: ?>
